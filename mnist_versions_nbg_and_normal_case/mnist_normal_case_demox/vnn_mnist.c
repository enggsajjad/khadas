...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    node[3]->nn_param.conv2d.weights = 50;
    ...
    node[7]->nn_param.fcl.weights = 500;
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[1] = 1;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0865173265337944;
    ...
    attr.size[3] = 20;
    attr.dim_num = 4;
    attr.dtype.scale = 0.002246841322630644;
    attr.dtype.zero_point = 127;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[0] = 20;
    attr.dim_num = 1;
    attr.dtype.scale = 8.811142962770807e-06;
    ...
    attr.size[3] = 50;
    attr.dim_num = 4;
    attr.dtype.scale = 0.00137136725243181;
    attr.dtype.zero_point = 105;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[2], attr, VSI_NN_TYPE_UINT8, 1780, 25000);

    /* @Conv_Conv_3_8:bias */
    attr.size[0] = 50;
    attr.dim_num = 1;
    attr.dtype.scale = 2.064674990199665e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[3], attr, VSI_NN_TYPE_INT32, 1580, 200);

    /* @Gemm_Gemm_9_4:weight */
    attr.size[0] = 800;
    attr.size[1] = 500;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0006903648609295487;
    attr.dtype.zero_point = 124;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[4], attr, VSI_NN_TYPE_UINT8, 33820, 400000);

    /* @Gemm_Gemm_9_4:bias */
    attr.size[0] = 500;
    attr.dim_num = 1;
    attr.dtype.scale = 3.21017430470515e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[5], attr, VSI_NN_TYPE_INT32, 31820, 2000);

    /* @Gemm_Gemm_11_2:weight */
    attr.size[0] = 500;
    attr.size[1] = 10;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0016333303647115827;
    attr.dtype.zero_point = 127;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[6], attr, VSI_NN_TYPE_UINT8, 26820, 5000);

    /* @Gemm_Gemm_11_2:bias */
    attr.size[0] = 10;
    attr.dim_num = 1;
    attr.dtype.scale = 5.202382784895085e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[7], attr, VSI_NN_TYPE_INT32, 26780, 40);



    /* @Conv_Conv_0_11:out0 */
    attr.dtype.scale = 0.015055594965815544;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_3_8:out0 */
    attr.dtype.scale = 0.04649967700242996;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Gemm_Gemm_9_4:out0 */
    attr.dtype.scale = 0.031851381063461304;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Gemm_Gemm_11_2:out0 */
    attr.dtype.scale = 0.0865173190832138;
