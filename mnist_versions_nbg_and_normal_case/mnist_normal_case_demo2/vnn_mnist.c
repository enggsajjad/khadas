...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    node[13]->nn_param.fcl.weights = 500;
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[1] = 1;
    attr.dim_num = 2;
    attr.dtype.scale = 0.08289191871881485;
    ...
    attr.size[3] = 20;
    attr.dim_num = 4;
    attr.dtype.scale = 0.002084288978949189;
    ...
    attr.size[0] = 20;
    attr.dim_num = 1;
    attr.dtype.scale = 8.173682753772238e-06;
    ...
    attr.size[3] = 20;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0013811641838401556;
    ...
    attr.size[0] = 20;
    attr.dim_num = 1;
    attr.dtype.scale = 1.4413401499242069e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[3] = 50;
    attr.dim_num = 4;
    attr.dtype.scale = 0.002954283030703664;
    ...
    attr.size[0] = 50;
    attr.dim_num = 1;
    attr.dtype.scale = 8.939601132515376e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[3] = 50;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0023024866823107004;
    ...
    attr.size[0] = 50;
    attr.dim_num = 1;
    attr.dtype.scale = 8.190210025858617e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[3] = 50;
    attr.dim_num = 4;
    attr.dtype.scale = 0.002642619889229536;
    attr.dtype.zero_point = 102;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[8], attr, VSI_NN_TYPE_UINT8, 15760, 2500);

    /* @Conv_Conv_9_8:bias */
    attr.size[0] = 50;
    attr.dim_num = 1;
    attr.dtype.scale = 0.00018851245879866405;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[9], attr, VSI_NN_TYPE_INT32, 15560, 200);

    /* @Gemm_Gemm_15_4:weight */
    attr.size[0] = 800;
    attr.size[1] = 500;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0008393212920054793;
    attr.dtype.zero_point = 129;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[10], attr, VSI_NN_TYPE_UINT8, 20260, 400000);

    /* @Gemm_Gemm_15_4:bias */
    attr.size[0] = 500;
    attr.dim_num = 1;
    attr.dtype.scale = 6.900669163806186e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[11], attr, VSI_NN_TYPE_INT32, 18260, 2000);

    /* @Gemm_Gemm_17_2:weight */
    attr.size[0] = 500;
    attr.size[1] = 10;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0015196372987702489;
    attr.dtype.zero_point = 139;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[12], attr, VSI_NN_TYPE_UINT8, 420300, 5000);

    /* @Gemm_Gemm_17_2:bias */
    attr.size[0] = 10;
    attr.dim_num = 1;
    attr.dtype.scale = 5.0897190944255034e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[13], attr, VSI_NN_TYPE_INT32, 420260, 40);



    /* @Conv_Conv_0_17:out0 */
    attr.dtype.scale = 0.01043569017201662;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_3_14:out0 */
    attr.dtype.scale = 0.03025979921221733;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_5_12:out0 */
    attr.dtype.scale = 0.0355711504817009;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_7_10:out0 */
    attr.dtype.scale = 0.07133544236421585;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_9_8:out0 */
    attr.dtype.scale = 0.0822172537446022;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Gemm_Gemm_15_4:out0 */
    attr.dtype.scale = 0.03349298611283302;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Gemm_Gemm_17_2:out0 */
    attr.dtype.scale = 0.08289185166358948;
