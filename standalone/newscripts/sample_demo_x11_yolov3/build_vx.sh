...
#aarch64-linux-gnu-gcc -c yolo_v3.c -o ./bin_r_cv4/yolo_v3.o -I./include -I$OPENCV_ROOT/modules -I$OPENCV_ROOT/modules/highgui/include -I$OPENCV_ROOT/modules/core/include  -I$OPENCV_ROOT/modules/imgproc/include -I$OPENCV_ROOT/modules/objdetect/include -I$OPENCV_ROOT/modules/imgcodecs/include -I$OPENCV_ROOT/modules/videoio/include -I$OPENCV4_ROOT -I. -I$VIVANTE_SDK_INC
#aarch64-linux-gnu-gcc -c vnn_yolov3.c -o ./bin_r_cv4/vnn_yolov3.o -I./include -I$OPENCV_ROOT/modules -I$OPENCV_ROOT/modules/highgui/include -I$OPENCV_ROOT/modules/core/include  -I$OPENCV_ROOT/modules/imgproc/include -I$OPENCV_ROOT/modules/objdetect/include -I$OPENCV_ROOT/modules/imgcodecs/include -I$OPENCV_ROOT/modules/videoio/include -I$OPENCV4_ROOT -I. -I$VIVANTE_SDK_INC
#aarch64-linux-gnu-gcc -c yolov3_process.c -o ./bin_r_cv4/yolov3_process.o -I./include -I$OPENCV_ROOT/modules -I$OPENCV_ROOT/modules/highgui/include -I$OPENCV_ROOT/modules/core/include  -I$OPENCV_ROOT/modules/imgproc/include -I$OPENCV_ROOT/modules/objdetect/include -I$OPENCV_ROOT/modules/imgcodecs/include -I$OPENCV_ROOT/modules/videoio/include -I$OPENCV4_ROOT -I. -I$VIVANTE_SDK_INC
#aarch64-linux-gnu-gcc -c detect_log.c -o ./bin_r_cv4/detect_log.o -I./include -I$OPENCV_ROOT/modules -I$OPENCV_ROOT/modules/highgui/include -I$OPENCV_ROOT/modules/core/include  -I$OPENCV_ROOT/modules/imgproc/include -I$OPENCV_ROOT/modules/objdetect/include -I$OPENCV_ROOT/modules/imgcodecs/include -I$OPENCV_ROOT/modules/videoio/include -I$OPENCV4_ROOT -I. -I$VIVANTE_SDK_INC
#aarch64-linux-gnu-g++ -c main.cpp -o ./bin_r_cv4/main.o -I./include -I$OPENCV_ROOT/modules -I$OPENCV_ROOT/modules/highgui/include -I$OPENCV_ROOT/modules/core/include  -I$OPENCV_ROOT/modules/imgproc/include -I$OPENCV_ROOT/modules/objdetect/include -I$OPENCV_ROOT/modules/imgcodecs/include -I$OPENCV_ROOT/modules/videoio/include -I$OPENCV4_ROOT -I. -I$VIVANTE_SDK_INC

#aarch64-linux-gnu-g++ ./bin_r_cv4/*.o -o test -L$OPENCV_ROOT/lib  -lopencv_imgproc -lopencv_core -lopencv_videoio -lopencv_imgcodecs -lopencv_highgui -lz -lm -L$VIVANTE_SDK_LIB -lOpenVX -lOpenVXU -lGAL -lovxlib -lArchModelSw -lNNArchPerf -lvpcodec -lamcodec -lamadec -lamvdec -lamavutils -lrt -lpthread -lge2d -lion
