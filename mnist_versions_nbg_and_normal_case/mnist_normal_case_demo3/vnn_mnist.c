...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    node[15]->nn_param.fcl.weights = 500;
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[1] = 1;
    attr.dim_num = 2;
    attr.dtype.scale = 0.08153790235519409;
    ...
    attr.size[3] = 20;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0020687764044851065;
    ...
    attr.size[0] = 20;
    attr.dim_num = 1;
    attr.dtype.scale = 8.112849124825255e-06;
    ...
    attr.size[3] = 20;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0014375498285517097;
    attr.dtype.zero_point = 108;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[2], attr, VSI_NN_TYPE_UINT8, 4360, 10000);

    /* @Conv_Conv_3_16:bias */
    attr.size[0] = 20;
    attr.dim_num = 1;
    attr.dtype.scale = 1.3608818520389728e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[3], attr, VSI_NN_TYPE_INT32, 4280, 80);
    ...
    attr.size[3] = 50;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0030443882569670677;
    attr.dtype.zero_point = 106;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[4], attr, VSI_NN_TYPE_UINT8, 14560, 1000);

    /* @Conv_Conv_5_14:bias */
    attr.size[0] = 50;
    attr.dim_num = 1;
    attr.dtype.scale = 4.7688953671968376e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[5], attr, VSI_NN_TYPE_INT32, 14360, 200);
    ...
    attr.size[3] = 50;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0022018400486558676;
    attr.dtype.zero_point = 93;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[6], attr, VSI_NN_TYPE_UINT8, 15760, 2500);

    /* @Conv_Conv_7_12:bias */
    attr.size[0] = 50;
    attr.dim_num = 1;
    attr.dtype.scale = 5.265027108875258e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[7], attr, VSI_NN_TYPE_INT32, 15560, 200);
    ...
    attr.size[3] = 50;
    attr.dim_num = 4;
    attr.dtype.scale = 0.002001409884542227;
    attr.dtype.zero_point = 99;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[8], attr, VSI_NN_TYPE_UINT8, 18460, 2500);

    /* @Conv_Conv_9_10:bias */
    attr.size[0] = 50;
    attr.dim_num = 1;
    attr.dtype.scale = 6.535277549920768e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[9], attr, VSI_NN_TYPE_INT32, 18260, 200);
    ...
    attr.size[3] = 50;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0023015723563730717;
    ...
    attr.size[0] = 50;
    attr.dim_num = 1;
    attr.dtype.scale = 0.00010121292895253452;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[1] = 500;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0012514319969341159;
    attr.dtype.zero_point = 143;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[12], attr, VSI_NN_TYPE_UINT8, 22960, 400000);

    /* @Gemm_Gemm_17_4:bias */
    attr.size[0] = 500;
    attr.dim_num = 1;
    attr.dtype.scale = 0.00010294794933531169;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[13], attr, VSI_NN_TYPE_INT32, 20960, 2000);

    /* @Gemm_Gemm_19_2:weight */
    attr.size[0] = 500;
    attr.size[1] = 10;
    attr.dim_num = 2;
    attr.dtype.scale = 0.001598646049387753;
    attr.dtype.zero_point = 125;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[14], attr, VSI_NN_TYPE_UINT8, 423000, 5000);

    /* @Gemm_Gemm_19_2:bias */
    attr.size[0] = 10;
    attr.dim_num = 1;
    attr.dtype.scale = 5.650869341161614e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[15], attr, VSI_NN_TYPE_INT32, 422960, 40);



    /* @Conv_Conv_0_19:out0 */
    attr.dtype.scale = 0.009466676041483879;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_3_16:out0 */
    attr.dtype.scale = 0.015664543956518173;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_5_14:out0 */
    attr.dtype.scale = 0.023911941796541214;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_7_12:out0 */
    attr.dtype.scale = 0.03265336900949478;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_9_10:out0 */
    attr.dtype.scale = 0.04397555813193321;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_11_8:out0 */
    attr.dtype.scale = 0.08226411789655685;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Gemm_Gemm_17_4:out0 */
    attr.dtype.scale = 0.035347845405340195;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Gemm_Gemm_19_2:out0 */
    attr.dtype.scale = 0.08153767138719559;
