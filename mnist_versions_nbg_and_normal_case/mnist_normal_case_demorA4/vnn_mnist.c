...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    node[13]->nn_param.conv2d.weights = 500;
    ...
    node[17]->nn_param.fcl.weights = 5000;
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[1] = 1;
    attr.dim_num = 2;
    attr.dtype.scale = 0.03606665879487991;
    ...
    attr.size[3] = 200;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0011675386922433972;
    ...
    attr.size[0] = 200;
    attr.dim_num = 1;
    attr.dtype.scale = 4.578583377609603e-06;
    ...
    attr.size[3] = 200;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0003564838843885809;
    attr.dtype.zero_point = 95;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[2], attr, VSI_NN_TYPE_UINT8, 520600, 1000000);

    /* @Conv_Conv_3_18:bias */
    attr.size[0] = 200;
    attr.dim_num = 1;
    attr.dtype.scale = 1.0351491026157312e-06;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[3], attr, VSI_NN_TYPE_INT32, 519800, 800);
    ...
    attr.size[3] = 500;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0007803489570505917;
    attr.dtype.zero_point = 109;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[4], attr, VSI_NN_TYPE_UINT8, 1522600, 100000);

    /* @Conv_Conv_5_16:bias */
    attr.size[0] = 500;
    attr.dim_num = 1;
    attr.dtype.scale = 7.65219393389897e-06;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[5], attr, VSI_NN_TYPE_INT32, 1520600, 2000);
    ...
    attr.size[3] = 500;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0005362080410122871;
    attr.dtype.zero_point = 104;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[6], attr, VSI_NN_TYPE_UINT8, 1624600, 250000);

    /* @Conv_Conv_7_14:bias */
    attr.size[0] = 500;
    attr.dim_num = 1;
    attr.dtype.scale = 4.028510625471698e-06;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[7], attr, VSI_NN_TYPE_INT32, 1622600, 2000);
    ...
    attr.size[3] = 500;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0005404752446338534;
    attr.dtype.zero_point = 102;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[8], attr, VSI_NN_TYPE_UINT8, 1876600, 250000);

    /* @Conv_Conv_9_12:bias */
    attr.size[0] = 500;
    attr.dim_num = 1;
    attr.dtype.scale = 6.30603330702324e-06;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[9], attr, VSI_NN_TYPE_INT32, 1874600, 2000);
    ...
    attr.size[3] = 500;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0006194078596308827;
    ...
    attr.size[0] = 500;
    attr.dim_num = 1;
    attr.dtype.scale = 1.2712651228350769e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[3] = 500;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0005962727591395378;
    attr.dtype.zero_point = 107;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[12], attr, VSI_NN_TYPE_UINT8, 269800, 250000);

    /* @Conv_Conv_13_8:bias */
    attr.size[0] = 500;
    attr.dim_num = 1;
    attr.dtype.scale = 1.2988330656035774e-05;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[13], attr, VSI_NN_TYPE_INT32, 267800, 2000);

    /* @Gemm_Gemm_19_4:weight */
    attr.size[0] = 8000;
    attr.size[1] = 5000;
    attr.dim_num = 2;
    attr.dtype.scale = 0.00019571551820263267;
    attr.dtype.zero_point = 133;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[14], attr, VSI_NN_TYPE_UINT8, 2146600, 40000000);

    /* @Gemm_Gemm_19_4:bias */
    attr.size[0] = 5000;
    attr.dim_num = 1;
    attr.dtype.scale = 4.967480496253173e-06;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[15], attr, VSI_NN_TYPE_INT32, 2126600, 20000);

    /* @Gemm_Gemm_21_2:weight */
    attr.size[0] = 5000;
    attr.size[1] = 10;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0005406008567661047;
    attr.dtype.zero_point = 126;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[16], attr, VSI_NN_TYPE_UINT8, 42146640, 50000);

    /* @Gemm_Gemm_21_2:bias */
    attr.size[0] = 10;
    attr.dim_num = 1;
    attr.dtype.scale = 4.568779377765167e-06;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[17], attr, VSI_NN_TYPE_INT32, 42146600, 40);



    /* @Conv_Conv_0_21:out0 */
    attr.dtype.scale = 0.0029037753120064735;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_3_18:out0 */
    attr.dtype.scale = 0.009806117974221706;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_5_16:out0 */
    attr.dtype.scale = 0.007512961979955435;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_7_14:out0 */
    attr.dtype.scale = 0.011667571030557156;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_9_12:out0 */
    attr.dtype.scale = 0.020523877814412117;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.dtype.scale = 0.021782532334327698;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_13_8:out0 */
    attr.dtype.scale = 0.02538112737238407;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Gemm_Gemm_19_4:out0 */
    attr.dtype.scale = 0.00845129881054163;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Gemm_Gemm_21_2:out0 */
    attr.dtype.scale = 0.035533346235752106;
    attr.dtype.zero_point = 105;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
