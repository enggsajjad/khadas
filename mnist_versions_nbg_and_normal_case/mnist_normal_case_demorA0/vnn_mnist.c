...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    node[9]->nn_param.fcl.weights = 5000;
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[1] = 1;
    attr.dim_num = 2;
    attr.dtype.scale = 0.02541625313460827;
    ...
    attr.size[3] = 200;
    attr.dim_num = 4;
    attr.dtype.scale = 0.0013125162804499269;
    attr.dtype.zero_point = 127;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[0] = 200;
    attr.dim_num = 1;
    attr.dtype.scale = 5.147122972826688e-06;
    ...
    attr.size[3] = 200;
    attr.dim_num = 4;
    attr.dtype.scale = 0.000374540250049904;
    ...
    attr.size[0] = 200;
    attr.dim_num = 1;
    attr.dtype.scale = 1.765989474811501e-06;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[3] = 500;
    attr.dim_num = 4;
    attr.dtype.scale = 0.000844704860355705;
    ...
    attr.size[0] = 500;
    attr.dim_num = 1;
    attr.dtype.scale = 7.4691311667571085e-06;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    attr.size[1] = 5000;
    attr.dim_num = 2;
    attr.dtype.scale = 0.00015258771600201726;
    attr.dtype.zero_point = 141;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[6], attr, VSI_NN_TYPE_UINT8, 1138600, 40000000);

    /* @Gemm_Gemm_11_4:bias */
    attr.size[0] = 5000;
    attr.dim_num = 1;
    attr.dtype.scale = 1.0965576065788212e-06;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[7], attr, VSI_NN_TYPE_INT32, 1118600, 20000);

    /* @Gemm_Gemm_13_2:weight */
    attr.size[0] = 5000;
    attr.size[1] = 10;
    attr.dim_num = 2;
    attr.dtype.scale = 0.0005607214407064021;
    attr.dtype.zero_point = 129;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[8], attr, VSI_NN_TYPE_UINT8, 41138640, 50000);

    /* @Gemm_Gemm_13_2:bias */
    attr.size[0] = 10;
    attr.dim_num = 1;
    attr.dtype.scale = 1.5142783591596962e-06;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    NEW_CONST_TENSOR(const_tensor[9], attr, VSI_NN_TYPE_INT32, 41138600, 40);



    /* @Conv_Conv_0_13:out0 */
    attr.dtype.scale = 0.004715085960924625;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_3_10:out0 */
    attr.dtype.scale = 0.00884229689836502;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Conv_Conv_5_8:out0 */
    attr.dtype.scale = 0.007186408154666424;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Gemm_Gemm_11_4:out0 */
    attr.dtype.scale = 0.0027005893643945456;
    attr.dtype.zero_point = 0;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_AFFINE_ASYMMETRIC;
    ...
    /* @Gemm_Gemm_13_2:out0 */
    attr.dtype.scale = 0.02404181659221649;
