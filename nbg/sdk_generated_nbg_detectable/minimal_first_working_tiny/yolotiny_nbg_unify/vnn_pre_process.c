    ...
    )
{
	...
	yolo_tiny_preprocess_nbg(image,pdata,graph,nn_width,nn_height,3);
    ...
    stbi_write_jpg("output.jpg",nn_width, nn_height, nn_channel, data, 100);//Sajjad
    ...
    )
{
    ...
    {
        printf("vnn_PreProcessYolotiny_ImageProcess Only support JPG image file\n");
        status = VSI_FAILURE;
        TEST_CHECK_STATUS(status, final);
    }
